...
class PeminjamanBiasaController extends Controller
{
    ...
    {
        $pinjamanbiasa = PinjamanBiasa::all();
        return view('ketua.status_biasa',['pinjamanbiasa' => $pinjamanbiasa]);
    }

    public function index_pengawas()
    {
        $pinjamanbiasa = PinjamanBiasa::all();
        return view('pengawas.status_biasa',['pinjamanbiasa' => $pinjamanbiasa]);
    }
    public function index_bendahara()
    {
        $pinjamanbiasa = PinjamanBiasa::all();
        return view('bendahara.status_biasa',['pinjamanbiasa' => $pinjamanbiasa]);
    }
    /**
