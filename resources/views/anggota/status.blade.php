...
@php
    $dataAnggota = session('dataAnggota');
@endphp
...
<tbody>
        ...
        <tr>
            ...
            <td>
                @if ($data->status == 'terima')
                    <button class="btn btn-success" style="pointer-events: none; user-select: none;">Disetujui</button>
                @elseif ($data->status == 'tolak')
                    <button class="btn btn-danger" style="pointer-events: none; user-select: none;">Ditolak</button>
                    @elseif ($data->status == 'sedang menunggu validasi pengawas')
                    <button class="btn btn-primary" style="pointer-events: none; user-select: none;">sedang menunggu validasi pengawas</button>
                    @elseif ($data->status == 'sedang menunggu validasi bendahara')
                    <button class="btn btn-primary" style="pointer-events: none; user-select: none;">sedang menunggu validasi bendahara</button>
                    @elseif ($data->status == 'sedang menunggu validasi ketua')
                    <button class="btn btn-primary" style="pointer-events: none; user-select: none;">sedang menunggu validasi ketua</button>
                @else
                    <a href="#" class="btn btn-primary">Sedang Menunggu</a>
    ...
    @empty
        <tr>
            <td colspan="6">Tidak ada data pinjaman.</td>
        </tr>
    @endforelse
</tbody>
