        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid row justify-content px-4">
                    <h1 class="mt-4 mb-4">Data Pinjaman Urgent Anggota</h1>
                                ...
                                <table id="datatablesSimple" class="table table-bordered table-striped">
                                    <thead>
                                        ...
                                        <tbody>
                                            ...
                                            @if($data->jenis_pinjaman == 'Pinjaman Khusus')
                                                <tr>
                                                    <td> {{ $index+1 }}</td>
                                                    ...
                                                    <td >
                                                        ...
                                                        @elseif ($data->status == 'sedang menunggu validasi bendahara')
                                                            <span class="btn btn-warning" style="pointer-events: none; user-select: none;">Menunggu Validasi Bendahara</span>
                                                        @else
                                                            <form action="{{ route('pengawas.validasi_PeminjamanKhusus', ['id' => $data->id]) }}" method="POST">
                                                                @csrf
                                                                <button type="submit" name="action" value="sedang menunggu validasi bendahara" class="btn btn-success">Terima</button>
