                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" style="width: 100%;" name="nomor_ktp" value="{{ $data['nomor_ktp'] }}" readonly>
                        </div>
                    </div>
                </div>
                <p></p>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="masa_berlaku_ktp"
                                            id="masa_berlaku_ktp" value="{{ $data['masa_berlaku_ktp'] }}"readonly>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control" name="alamat_ktp"
                                            placeholder="{{ $data['alamat'] }}" readonly></textarea>
                                    </div>
                                </div>
                            </div>
                            <p></p>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="kelurahan_ktp"
                                            value="{{ $data['kelurahan_ktp'] }}" readonly>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="kecamatan_ktp"
                                            value="{{ $data['kecamatan_ktp'] }}" readonly>
                                    </div>
                                </div>
                            </div>
                            <p></p>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="kodepos_ktp"
                                            value="{{ $data['kodepos_ktp'] }}" readonly>
                                    </div>
                                </div>
                            </div>
                            <p></p>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control" name="alamat"
                                            placeholder="{{ $data['alamat_ktp'] }}" readonly></textarea>
                                    </div>
                                </div>
                            </div>
                            <p></p>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="no_telepon_rumah"
                                            value="{{ $data['no_telepon_rumah'] }}" readonly>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="no_telepon_hp"
                                            value="{{ $data['no_telepon_hp'] }}" readonly>
                                    </div>
                                </div>
                            </div>
                            <p></p>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input name="status_tempat_tinggal" id="status_tempat_tinggal"
                                            class="form-control" value="{{ $data['status_tempat_tinggal'] }}" readonly>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="menempati_alamat_tsb_sejak"
                                            value="{{ $data['menempati_alamat_tsb_sejak'] }}" readonly>
                                    </div>
                                </div>
                            </div>
                            <p></p>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input name="pendidikan_terakhir" id="pendidikan_terakhir" class="form-control"
                                            value="{{ $data['pendidikan_terakhir'] }}" readonly>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nama_istri_suami"
                                            value="{{ $data['nama_istri_suami'] }}" readonly>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <input type="number" class="form-control" class="form-check-input"
                                                    name="jumlah_anak" value="{{ $data['jumlah_anak'] }}"
                                                    readonly>
                                            </div>
                                            <div class="col">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nama_ibu_kandung_pemohon"
                                            value="{{ $data['nama_ibu_kandung_pemohon'] }}" readonly>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="npwp_pribadi"
                                            value="{{ $data['npwp_pribadi'] }}" readonly>
                                    </div>
                                </div>
                            </div>
                            <p></p>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nama_ahli_waris"
                                            value="{{ $data['nama_ahli_waris'] }}" readonly>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="no_telp_ext_kantor"
                                            value="{{ $data['no_telp_ext_kantor'] }}" readonly>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nomor_rekening"
                                            value="{{ $data['nomor_rekening'] }}" readonly>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="tgl_masuk_keperusahaan"
                                            value="{{ $data['tgl_masuk_ke_perusahaan'] }}" readonly>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input name="status_karyawan" id="status_karyawan" class="form-control"
                                            value="{{ $data['status_karyawan'] }}" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
