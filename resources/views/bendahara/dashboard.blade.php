                ...
                <div class="container px-4">
                    ...
                    <div class="row text-center">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="card mb-4 shadow" style="background-color: #0d6efd;">
                                <div class="card-body text-white">
                                    <h2 class="fs-2 fw-bold">100 Anggota</h2>
                                    <h4 class="fs-4 fw-semibold">Laki-laki</h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="card mb-4 shadow" style="background-color: #Fc58aa;">
                                <div class="card-body text-white">
                                    <h2 class="fs-2 fw-bold">100 Anggota</h2>
                                    <h4 class="fs-4 fw-semibold">Perempuan</h4>
                                </div>
                            </div>
                        </div>
                    </div>
