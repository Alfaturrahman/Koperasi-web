                            ...
                            <div style="overflow-x: auto;">
                                <table id="datatablesSimple" class="table table-bordered table-striped">
                                    <thead>
                                        ...
                                        <tbody>
                                            @forelse($pinjamanurgent as $index => $data)
                                                <tr>
                                                    <td> {{ $index+1 }}</td>
                                                    ...
                                                    <td >
                                                        ...
                                                        @else
                                                            <form action="{{ route('bendahara.validasi_PeminjamanUrgent', ['id' => $data->id]) }}" method="POST">
                                                                @csrf
                                                                <button type="submit" name="action" value="sedang menunggu validasi ketua" class="btn btn-success">Terima</button>
